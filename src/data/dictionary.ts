...
export const dict = {
  ...
  cmdSearch: { en: 'Search schools and sages…', pt: 'Buscar escolas e sábios…' },
  cmdSchools: { en: 'Schools', pt: 'Escolas' },
  cmdSages: { en: 'Sages', pt: 'Sábios' },
  cmdEmpty: { en: 'No results', pt: 'Nenhum resultado' },
  cmdHint: { en: '⌘K to search', pt: '⌘K para buscar' },
